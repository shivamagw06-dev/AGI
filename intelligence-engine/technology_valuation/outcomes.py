...
TRACKED_METRICS=frozenset({"revenue_growth","constant_currency_growth","ebit_margin","fcf_margin","utilization","attrition","book_to_bill"})
...
def build_outcome_record(*, company_id: str, metric: str, predicted_value: float, actual_value: float,
    ...
    return {"status":"PROPOSED","company_id":company_id,"subsector":"IT_SERVICES","metric":key,
