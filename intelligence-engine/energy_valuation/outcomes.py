"""Reviewed Phase 5 outcome candidates; never self-promote."""
from __future__ import annotations
from datetime import datetime,timezone
from typing import Any
from energy_valuation.models import MODELS
def build_energy_outcome(*,company_id:str,subsector:str,metric:str,predicted_value:float,actual_value:float,predicted_at:str,evaluated_at:str,source_id:str,failed_assumptions:list[str]|None=None)->dict[str,Any]:
 family=str(subsector or "").upper(); allowed={x.key for x in MODELS[family].key_kpis} if family in MODELS else set()
