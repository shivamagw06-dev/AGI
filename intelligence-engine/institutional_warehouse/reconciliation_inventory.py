...
def inventory(tab_id: str, *, symbols: Optional[Iterable[str]] = None,
    ...
    totals = {
        "rows": 0,
        "companies": len(all_symbols),
        "groups": 0,
        "duplicate_groups": 0,
        "rows_in_duplicate_groups": 0,
        "rows_that_survive": 0,
        "rows_retirable": 0,
        "rows_sole_holder_of_a_metric": 0,
        "groups_with_no_canonical_candidate": 0,
        "groups_with_value_conflicts": 0,
        "groups_with_mixed_units": 0,
        "rows_with_unknown_units": 0,
        "same_source_duplicate_rows": 0,
        "cross_source_duplicate_rows": 0,
        "raw_label_duplicate_groups": 0,
        "unknown_or_null_statement_type_rows": 0,
        "rows_in_groups_with_no_canonical_candidate": 0,
