...
# --------------------------------------------------------------------------
# Alpha Validation and Investment Operating System
# --------------------------------------------------------------------------

STRATEGY_DEFINITIONS = Tab(
    id="strategy_definitions",
    label="Strategy Definitions",
    description="Immutable, versioned strategy contracts. A formula change creates a new version.",
    mode="append",
    key=("strategy_id", "version"),
    order_by=("strategy_id", "version DESC"),
    search_columns=("strategy_id", "strategy_name", "owner", "role"),
    icon="strategy",
    columns=(
        _c("strategy_id", "Strategy ID", TEXT, required=True, width=180, group="Identity"),
        _c("version", "Version", INTEGER, required=True, width=85, group="Identity"),
        _c("definition_hash", "Definition Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("strategy_name", "Strategy", TEXT, required=True, width=220, group="Identity"),
        _c("owner", "Owner", TEXT, required=True, width=180, group="Governance"),
        _c("role", "Research Role", TEXT, required=True, width=220, group="Governance"),
        _c("declared_status", "Declared Status", TEXT, required=True, width=150, group="Governance"),
        _c("definition_json", "Definition", JSON, required=True, width=360, group="Contract"),
        _c("created_at", "Created At", DATETIME, required=True, width=170, group="Audit"),
        _c("approved_at", "Approved At", DATETIME, width=170, group="Audit"),
    ),
)

STRATEGY_RESEARCH_RUNS = Tab(
    id="strategy_research_runs",
    label="Strategy Research Runs",
    description="Reproducible run manifests binding code, data, universe, features, actions and costs.",
    mode="append",
    key=("run_id",),
    order_by=("started_at DESC",),
    search_columns=("run_id", "strategy_id", "code_commit", "run_status"),
    icon="strategy",
    columns=(
        _c("run_id", "Run ID", TEXT, required=True, width=210, group="Identity"),
        _c("strategy_id", "Strategy ID", TEXT, required=True, width=180, group="Identity"),
        _c("strategy_version", "Version", INTEGER, required=True, width=85, group="Identity"),
        _c("definition_hash", "Definition Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("manifest_hash", "Manifest Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("manifest_json", "Manifest", JSON, required=True, width=360, group="Contract"),
        _c("code_commit", "Code Commit", TEXT, required=True, width=180, group="Inputs"),
        _c("dataset_hash", "Dataset Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("universe_hash", "Universe Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("feature_hash", "Feature Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("corporate_action_hash", "Action Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("cost_model_hash", "Cost Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("parameters_hash", "Parameters Hash", TEXT, required=True, width=240, group="Inputs"),
        _c("start_date", "Start", DATE, required=True, width=115, group="Window"),
        _c("end_date", "End", DATE, required=True, width=115, group="Window"),
        _c("information_cutoff", "Information Cutoff", TEXT, required=True, width=260, group="Contract"),
        _c("run_status", "Status", TEXT, required=True, width=120, group="Status"),
        _c("started_at", "Started", DATETIME, required=True, width=170, group="Status"),
        _c("completed_at", "Completed", DATETIME, width=170, group="Status"),
    ),
)

STRATEGY_RUN_ARTIFACTS = Tab(
    id="strategy_run_artifacts",
    label="Strategy Run Artifacts",
    description="Content-addressed, append-only outputs for auditable research runs.",
    mode="append",
    key=("artifact_id",),
    order_by=("created_at DESC",),
    search_columns=("artifact_id", "run_id", "artifact_kind"),
    icon="strategy",
    columns=(
        _c("artifact_id", "Artifact ID", TEXT, required=True, width=220, group="Identity"),
        _c("run_id", "Run ID", TEXT, required=True, width=210, group="Identity"),
        _c("artifact_kind", "Kind", TEXT, required=True, width=130, group="Identity"),
        _c("payload_hash", "Payload Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("payload_json", "Payload", JSON, required=True, width=360, group="Artifact"),
        _c("created_at", "Created At", DATETIME, required=True, width=170, group="Audit"),
    ),
)

POINT_IN_TIME_OBSERVATIONS = Tab(
    id="point_in_time_observations",
    label="Point-in-Time Observations",
    description="Revision-aware facts visible only from their true availability timestamp.",
    mode="append",
    key=("observation_id",),
    entity_column="company_id",
    order_by=("available_from DESC", "company_id", "metric_id"),
    search_columns=("company_id", "metric_id", "source", "revision_id"),
    icon="history",
    columns=(
        _c("observation_id", "Observation ID", TEXT, required=True, width=220, group="Identity"),
        _c("company_id", "Company", TEXT, required=True, width=140, group="Identity"),
        _c("metric_id", "Metric", TEXT, required=True, width=180, group="Identity"),
        _c("period_end", "Period End", DATE, required=True, width=120, group="Period"),
        _c("value", "Value", NUMBER, width=140, group="Fact"),
        _c("currency", "Currency", TEXT, width=90, group="Fact"),
        _c("unit", "Unit", TEXT, width=120, group="Fact"),
        _c("announcement_date", "Announcement", DATETIME, width=170, group="Availability"),
        _c("available_from", "Available From", DATETIME, required=True, width=170, group="Availability"),
        _c("source", "Source", TEXT, required=True, width=170, group="Provenance"),
        _c("source_document", "Source Document", TEXT, width=280, group="Provenance"),
        _c("revision_id", "Revision ID", TEXT, width=150, group="Revision"),
        _c("is_restatement", "Restatement", BOOL, width=105, group="Revision"),
        _c("provider", "Provider", TEXT, width=140, group="Provenance"),
        _c("parser_path", "Parser Path", TEXT, width=170, group="Provenance"),
    ),
)

UNIVERSE_MEMBERSHIP_HISTORY = Tab(
    id="universe_membership_history",
    label="Universe Membership History",
    description="Effective-dated investable universes preserving delisted and failed securities.",
    mode="append",
    key=("company_id", "index_id", "effective_from"),
    entity_column="company_id",
    order_by=("effective_from DESC", "index_id", "company_id"),
    search_columns=("company_id", "index_id", "status", "source"),
    icon="history",
    columns=(
        _c("company_id", "Company", TEXT, required=True, width=140, group="Identity"),
        _c("index_id", "Universe", TEXT, required=True, width=180, group="Identity"),
        _c("effective_from", "Effective From", DATE, required=True, width=130, group="Window"),
        _c("effective_to", "Effective To", DATE, width=130, group="Window"),
        _c("investable", "Investable", BOOL, required=True, width=100, group="Status"),
        _c("status", "Security Status", TEXT, width=140, group="Status"),
        _c("security_id", "Security ID", TEXT, width=150, group="Identity"),
        _c("isin", "ISIN", TEXT, width=140, group="Identity"),
        _c("source", "Source", TEXT, required=True, width=170, group="Provenance"),
        _c("source_document", "Source Document", TEXT, width=280, group="Provenance"),
    ),
...
CANONICAL_FEATURE_OBSERVATIONS = Tab(
    id="canonical_feature_observations",
    label="Canonical Feature Observations",
    description="Shared point-in-time features with definition and source-observation hashes.",
    mode="append",
    key=("company_id", "feature_id", "as_of", "definition_hash"),
    entity_column="company_id",
    order_by=("as_of DESC", "company_id", "feature_id"),
    search_columns=("company_id", "feature_id", "family"),
    icon="strategy",
    columns=(
        _c("company_id", "Company", TEXT, required=True, width=140, group="Identity"),
        _c("feature_id", "Feature", TEXT, required=True, width=180, group="Identity"),
        _c("as_of", "As Of", DATETIME, required=True, width=170, group="Availability"),
        _c("value", "Value", NUMBER, required=True, width=130, group="Feature"),
        _c("family", "Family", TEXT, required=True, width=120, group="Feature"),
        _c("definition_hash", "Definition Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("source_observation_hash", "Input Hash", TEXT, required=True, width=240, group="Integrity"),
        _c("available_from", "Available From", DATETIME, required=True, width=170, group="Availability"),
        _c("lineage_json", "Lineage", JSON, required=True, width=320, group="Provenance"),
    ),
)

STRATEGY_EXECUTION_SIMULATIONS = Tab(
    id="strategy_execution_simulations",
    label="Strategy Execution Simulations",
    description="Order-level latency, spread, volume, partial-fill and slippage simulations.",
    mode="append",
    key=("simulation_id", "order_id"),
    order_by=("created_at DESC",),
    search_columns=("simulation_id", "order_id", "strategy_id", "symbol", "status"),
    icon="strategy",
    columns=(
        _c("simulation_id", "Simulation ID", TEXT, required=True, width=210, group="Identity"),
        _c("order_id", "Order ID", TEXT, required=True, width=180, group="Identity"),
        _c("strategy_id", "Strategy", TEXT, required=True, width=180, group="Identity"),
        _c("symbol", "Symbol", TEXT, required=True, width=120, group="Order"),
        _c("side", "Side", TEXT, required=True, width=80, group="Order"),
        _c("requested_quantity", "Requested", NUMBER, required=True, width=120, group="Order"),
        _c("filled_quantity", "Filled", NUMBER, required=True, width=110, group="Fill"),
        _c("average_fill_price", "Average Fill", NUMBER, width=130, group="Fill"),
        _c("fill_rate", "Fill Rate", PERCENT, required=True, width=105, group="Fill"),
        _c("slippage_bps", "Slippage Bps", NUMBER, width=120, group="Cost"),
        _c("cost", "Cost", NUMBER, width=120, group="Cost"),
        _c("decision_latency_ms", "Latency Ms", INTEGER, width=115, group="Execution"),
        _c("status", "Status", TEXT, required=True, width=110, group="Execution"),
        _c("detail_json", "Detail", JSON, required=True, width=320, group="Audit"),
        _c("created_at", "Created At", DATETIME, required=True, width=170, group="Audit"),
    ),
)
...
STRATEGY_LIVE_ATTRIBUTION = Tab(
    ...
    description="Daily security, sector and factor P&L after transaction and slippage costs.",
    mode="append",
    key=("strategy_id", "as_of", "mode", "scope", "attribution_key"),
    order_by=("as_of DESC", "strategy_id"),
    search_columns=("strategy_id", "mode", "scope", "attribution_key"),
    icon="strategy",
    columns=(
        _c("strategy_id", "Strategy", TEXT, required=True, width=180, group="Identity"),
        _c("as_of", "As Of", DATE, required=True, width=120, group="Identity"),
        _c("mode", "Mode", TEXT, required=True, width=90, group="Identity"),
        _c("scope", "Scope", TEXT, required=True, width=100, group="Attribution"),
        _c("attribution_key", "Key", TEXT, required=True, width=170, group="Attribution"),
        _c("pnl", "Attributed P&L", NUMBER, required=True, width=130, group="Attribution"),
        _c("gross_pnl", "Gross P&L", NUMBER, width=120, group="Performance"),
