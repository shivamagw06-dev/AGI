...
COHORTS = {
    ...
    "INFRASTRUCTURE":{"ADANIPORTS","GMRINFRA","IRB"},
    "CONSTRUCTION":{"NBCC","PSPPROJECT","CAPACITE"},
    ...
    "CHEMICALS":{"TATACHEM","DEEPAKNTR","GNFC","DEEPAKFERT"},
    "SPECIALTY_CHEMICALS":{"PIIND","SRF","NAVINFLUOR","CLEAN","FLUOROCHEM"},
    "AUTO_AUTO_COMPONENTS":{"MARUTI","M&M","TATAMOTORS","BAJAJ-AUTO","EICHERMOT","MOTHERSON","BHARATFORG"},
