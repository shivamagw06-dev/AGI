...
_TOOLS = (
    ...
    ToolSpec("CALCULATE", "1.0", "read", "Run an allow-listed deterministic financial calculation.", "financial_calculation_engine", {"operation": _field("str", required=True, limit=60), "inputs": _field("dict", required=True, limit=50)}),
