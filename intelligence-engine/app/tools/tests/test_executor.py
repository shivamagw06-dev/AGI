...
def test_core_factory_binds_existing_services():
    ...
    assert executor.bound_tools == [
        ...
        "GET_CONSUMER_VALUATION", "GET_DOCUMENT", "GET_ENERGY_RESEARCH_CONTEXT", "GET_ENERGY_VALUATION", "GET_FINANCIAL_VALUATION", "GET_INDUSTRIAL_VALUATION", "GET_TECHNOLOGY_VALUATION", "SEARCH_RESEARCH",
    ]
