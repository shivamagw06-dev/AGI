...
export default function ArticlePreview({ open, onClose, article, html }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 overflow-y-auto py-8 px-4">
      <div className="relative w-full max-w-[90rem] bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="article-preview-shell mx-auto w-full max-w-[90rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10">
          <header className="article-preview-header mx-auto w-full max-w-6xl">
