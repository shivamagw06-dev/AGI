  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 overflow-y-auto py-8 px-4">
      <div className="relative w-full max-w-6xl bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="article-preview-shell px-4 py-6 sm:px-6 sm:py-8">
          <header className="article-preview-header mx-auto w-full max-w-5xl">
          ...
          <div
            className="article-prose prose prose-lg prose-neutral mx-auto mt-8 w-full max-w-3xl prose-headings:text-slate-900 prose-a:text-blue-700 prose-blockquote:border-blue-600"
