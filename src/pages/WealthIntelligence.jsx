  ...
  return <div className="wi-page">
    ...
    <div className="wi-shell">
      ...
      <section className="wi-panel" aria-labelledby="wi-discover">
        ...
        {connected ? <>
          <div className="wi-search-row"><label className="wi-search"><Search size={17} /><input aria-label="Search investment universe" placeholder={tab === 'equity' ? 'Search company, symbol or sector' : 'Search scheme, fund house or category'} value={query} onChange={e => setQuery(e.target.value)} /></label><span>{tab === 'equity' ? 'Shared market feed · 30-second refresh' : 'Upstox / AMFI · published daily NAV'} · Alphabetical order</span></div>
