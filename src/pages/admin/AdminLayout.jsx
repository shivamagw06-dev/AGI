...
const navItems = [
  ...
  { to: '/admin/upstox-bootstrap', label: 'AGI Valuation Bootstrap', icon: Database },
  ...
  { to: '/admin/publication-review', label: 'Publication Review', icon: Landmark },
  { to: '/admin/annual-report', label: 'Annual Report', icon: FileSearch },
  ...
  { to: '/admin/strategy-lab', label: 'Strategy Lab', icon: LineChart },
  { to: '/admin/options-lab', label: 'Options Lab', icon: Radar },
