...
export default function InvestorMappings(){
 ...
 <p>Use * only for an identity or membership verified across issuers. Family affiliation does not establish ownership of every company with a similar name. Managed fund assets are not personal wealth or the parent bank’s own investments.</p>
