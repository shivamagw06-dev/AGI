...
export default function InsiderTradesPaste() {
  ...
  return (
    <div className="itp">
      ...
      {country==='US'&&<div className="itp-help"><h2>US paste format</h2><p>Use tabs from Excel/Sheets or CSV, with a header row. Your Stock / Client Name / Reported to Exchange export is supported unchanged, with day/month/year dates (22/09/26 = 22 September 2026). OpenInsider-style exports use month/day/year. All values are USD, including comma-grouped amounts. Missing trade dates and plan status remain unknown.</p><p>Export columns: Stock · Client Name · Client Category · Action · Reported to Exchange · Quantity · Post Transaction Holding · Traded % · Avg. Price · Value · Security Type. Descriptive exercises, sales and tax-withholding actions are recognised. Generic acquisitions are not assumed to be market purchases; Traded % is not used as company ownership.</p><code>Company · Ticker · Insider Name · Title · Filing Date · Trade Date · Transaction Code · Quantity · Price · Value · Owned · 10b5-1 · SEC URL · Transaction ID · Derivative</code><p>P = purchase, S = sale, A = award, M = exercise, F = tax withholding, G = gift. P/S may be private transactions. Use a unique Transaction ID for otherwise identical trades. For Form 4/A amendments, reconcile the original before importing.</p></div>}
